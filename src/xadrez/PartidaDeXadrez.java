...
public class PartidaDeXadrez {
	...
	private Peca realizarMovimento(Posicao origem, Posicao destino) {
		...
		if (p instanceof Rei && destino.getColuna() == origem.getColuna() + 2) {
			...
			PecaDeXadrez rei = (PecaDeXadrez)tabuleiro.removerPeca(origemTorre);
			tabuleiro.colocarPeca(rei, destinoTorre);
			rei.incrementarQuantidadeMovimento();
		}
	...
	private void desfazerMovimento(Posicao origem, Posicao destino, Peca pecaCapiturada) {
		...
		if (p instanceof Rei && destino.getColuna() == origem.getColuna() + 2) {
			...
			torre.decrementarQantidadeMovimento();
		}
